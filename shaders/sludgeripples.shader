...
varying vec2 worldPos;
    ...
    void vert(){
        ...
        gl_FrontColor = vec4(texture(palettetex, vec2((outcolor.r*15.0+.5)/16.0,(palette+.5)/64.0)).rgb, outcolor.a*level_param);
    ...
    void frag(){
        ...
        vec2 rippleval = vec2(0.0, sin(timer*16+worldPos.y * .5)*sin(worldPos.x * .5)* .001);
